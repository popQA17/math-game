...
export default function Homepage(){
  return(<>
    ...
    <VStack position={'fixed'} top={0} w={'full'} zIndex={3} h={'full'}>
      ...
      <Text fontSize={'xl'}>Primary 5 / 6 Math Game 
        <math display="block">
          <mfrac>
            <mn>1</mn>
            <md>2</md>
      ...
      <Button _hover={{transform: 'scale(1.2)'}} px={'50px'} mt={'20px !important'} className={'movingGradient'} bgGradient={'linear(to-r, blue.300, pink.400)'} colorScheme={'blue'} color={'white'} size={'lg'} transition={'ease-in-out all 0.3s'} >Start</Button>
      <Spacer/>
